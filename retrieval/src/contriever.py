...
class Contriever(BertModel):
    # Contriever averages the hidden states of the last layer for pooling
...
class Dragon(BertModel):
    # Dragon uses CLS token for pooling
...
def load_retriever(model_path, pooling="average", random_init=False):
    ...
    if os.path.exists(path):
        ...
        elif "dragon" in retriever_model_id:
            model_class = Dragon
            print("Using Dragon model")
        else:
            model_class = Contriever
            print("Using Contriever model")
